...
var appRouter = function (app) {
  ...
  app.get("/api/client/:clientID/login", client.loginClient)
  ...
  app.get("/api/client/:clientID/checkCurrentTrip", client.checkPendingTrip)
  app.post("/api/client/:clientID/scoreTrip", client.scoreTrip)
